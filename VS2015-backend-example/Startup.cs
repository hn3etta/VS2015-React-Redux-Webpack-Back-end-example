...
namespace BackendStarter
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AddPolicy("BaselineAPI",
                                    policy => policy.RequireClaim("BasicAPI", "NormalUser"));
            });

            // Setup DI for Repos
            services.AddSingleton<IAuthorRepo, AuthorRepo>();
            services.AddSingleton<ICourseRepo, CourseRepo>();
            services.AddSingleton<ICourseOpenRepo, CourseOpenRepo>();
            ...
            // Add CORS support to this service
